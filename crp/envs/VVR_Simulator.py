...
class VVR_Simulator():
    ...
    def step(self, action, step=0):
        ...
        step=0.2
        # reward.append((-self.get_distortion()/100))#*(1-step)+step*(1-self.get_distortion(absolute=True, tollerance=15)/5))
        reward.append(-self.get_distortion(absolute=True, tollerance=0)/5)
